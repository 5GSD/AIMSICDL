...
import zz.aimsicd.lite.activities.AboutActivity;
import zz.aimsicd.lite.activities.BaseActivity;
import zz.aimsicd.lite.activities.DebugLogs;
import zz.aimsicd.lite.fragments.MapFragment;
import zz.aimsicd.lite.activities.SettingsActivity;
import zz.aimsicd.lite.adapters.AIMSICDDbAdapter;
import zz.aimsicd.lite.constants.DrawerMenu;
import zz.aimsicd.lite.drawer.DrawerMenuActivityConfiguration;
import zz.aimsicd.lite.drawer.NavDrawerItem;
import zz.aimsicd.lite.fragments.AtCommandFragment;
    ...
    void selectDrawerItem(int position) {
        ...
        switch (selectedItem.getId()) {
            ...
            case DrawerMenu.ID.APPLICATION.UPLOAD_LOCAL_BTS_DATA:
                ...
                new RequestTask(this, RequestTask.DBE_UPLOAD_REQUEST).execute("");
