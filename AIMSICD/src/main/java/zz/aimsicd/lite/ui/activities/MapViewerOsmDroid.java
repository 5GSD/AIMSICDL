...
public final class MapViewerOsmDroid extends BaseActivity implements OnSharedPreferenceChangeListener {
    ...
    private final BroadcastReceiver mMessageReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            loadEntries();
            if (mCellTowerGridMarkerClusterer != null && mCellTowerGridMarkerClusterer.getItems() != null) {
    ...
    private void loadPreferences() {
        String mapTypePref = getResources().getString(zz.aimsicd.lite.R.string.pref_map_type_key);
                ...
                if (mBound) {
                    ...
                    if (lastKnown != null) {
                        Helpers.msgLong(this,
                                getString(zz.aimsicd.lite.R.string.contacting_opencellid_for_data));
                        Cell cell;
        ...
        new AsyncTask<Void, Void, GeoPoint>() {
            ...
            protected GeoPoint doInBackground(Void... voids) {
                ...
                for (Cell cell : nc) {
                    ...
                    try {
                        ...
                        CellTowerMarker ovm = new CellTowerMarker(MapViewerOsmDroid.this, mMap,
                                getString(zz.aimsicd.lite.R.string.cell_id_label) + cell.getCID(),
                                "", loc,
                                new MarkerData(
                                        getApplicationContext(),
            ...
            protected void onPostExecute(GeoPoint defaultLoc) {
                ...
                if (mCellTowerGridMarkerClusterer != null) {
                    if (mCellTowerGridMarkerClusterer.getItems() != null) {
    ...
    private void loadOcidMarkersByNetwork() {
        ...
        if (c.moveToFirst()) {
            do {
                ...
                CellTowerMarker ovm = new CellTowerMarker(this, mMap, "Cell ID: " + cellID, "", location,
                        new MarkerData(
                                getApplicationContext(),
                                String.valueOf(cellID),
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        final String KEY_MAP_TYPE = getBaseContext().getString(zz.aimsicd.lite.R.string.pref_map_type_key);
