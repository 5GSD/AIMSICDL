...
public class AtCommandFragment extends InjectionFragment {
    ...
    @InjectView(zz.aimsicd.lite.R.id.at_command)
    private EditText mAtCommand;

    @InjectView(R.id.serial_device_spinner)
    private Spinner mSerialDeviceSpinner;

    @InjectView(zz.aimsicd.lite.R.id.serial_device_spinner_title)
    ...
    @InjectView(zz.aimsicd.lite.R.id.execute)
    ...
    public void onResume() {
        ...
        switch (serialDevice) {
            ...
            case ROOT_UNAVAILABLE:
                mAtCommandError.setText(zz.aimsicd.lite.R.string.unable_to_acquire_root_access);
                break;
            case BUSYBOX_UNAVAILABLE:
                mAtCommandError.setText(zz.aimsicd.lite.R.string.unable_to_detect_busybox);
                break;
