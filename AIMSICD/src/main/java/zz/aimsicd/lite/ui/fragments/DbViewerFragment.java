...
import zz.aimsicd.lite.adapters.BtsMeasureCardInflater;
import zz.aimsicd.lite.adapters.BtsMeasureItemData;
import zz.aimsicd.lite.adapters.CardItemData;
import zz.aimsicd.lite.adapters.DbViewerSpinnerAdapter;
import zz.aimsicd.lite.adapters.DbeImportCardInflater;
import zz.aimsicd.lite.adapters.DbeImportItemData;
import zz.aimsicd.lite.adapters.DefaultLocationCardInflater;
import zz.aimsicd.lite.adapters.EventLogCardInflater;
import zz.aimsicd.lite.adapters.EventLogItemData;
import zz.aimsicd.lite.adapters.MeasuredCellStrengthCardData;
import zz.aimsicd.lite.adapters.MeasuredCellStrengthCardInflater;
import zz.aimsicd.lite.adapters.SilentSmsCardData;
import zz.aimsicd.lite.adapters.UniqueBtsCardInflater;
import zz.aimsicd.lite.adapters.UniqueBtsItemData;
import zz.aimsicd.lite.constants.DBTableColumnIds;
import zz.aimsicd.lite.constants.Examples;
import zz.aimsicd.lite.enums.StatesDbViewer;
import zz.aimsicd.lite.smsdetection.CapturedSmsCardInflater;
import zz.aimsicd.lite.smsdetection.CapturedSmsData;
import zz.aimsicd.lite.smsdetection.DetectionStringsCardInflater;
...
public final class DbViewerFragment extends InjectionFragment {
    ...
    @InjectView(zz.aimsicd.lite.R.id.table_spinner)
    private Spinner tblSpinner;

    @InjectView(R.id.list_view)
    private ListView lv;

    @InjectView(zz.aimsicd.lite.R.id.db_list_empty)
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        DbViewerSpinnerAdapter mSpinnerAdapter = new DbViewerSpinnerAdapter(getActivity(), zz.aimsicd.lite.R.layout.item_spinner_db_viewer);
